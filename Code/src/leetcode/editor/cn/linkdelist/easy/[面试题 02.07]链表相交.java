package leetcode.editor.cn.linkdelist.easy;//给定两个（单向）链表，判定它们是否相交并返回交点。请注意相交的定义基于节点的引用，而不是基于节点的值。换句话说，如果一个链表的第k个节点与另一个链表的第j个
...
public class Solution {
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        //如果两个链表不相交. 最终tempA和tempB都是null.
        //如果想交,tempA和tempB会相等.
        while (tempA != tempB) {
            //如果其中任何一个遍历到头了,就把他指向另一个链表的头部,继续遍历
